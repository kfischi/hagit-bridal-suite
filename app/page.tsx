    ...
    <>
      ...
      <main ref={containerRef} className="relative bg-[#FAFAF8] text-[#2C241A]">
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${isActive ? 'text-[#C9A86A] bg-[#FAF6EE]' : 'text-[#4a3e2f] hover:text-[#C9A86A] hover:bg-[#FAF6EE]'}
                    `}
                  >
                    {link.label}
                  </button>
        ...
        <section id="hero" className="relative min-h-screen flex flex-col overflow-hidden bg-[#FAF6EE] pt-[64px]">
          <div className="relative h-[70vh] sm:h-[80vh] w-full overflow-hidden">
            <video autoPlay muted loop playsInline preload="auto" className="absolute inset-0 w-full h-full object-cover">
              <source src="https://res.cloudinary.com/dptyfvwyo/video/upload/q_auto,f_auto/v1769898872/HERO3_d2m9ny.mp4" type="video/mp4" />
            </video>
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 pt-10 pb-24 text-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.5 }}>
              <span className="text-[#A07840] text-sm tracking-[0.3em] uppercase font-medium block mb-6">וילת כלות יוקרתית בהרי ירושלים</span>
              <h1 className="font-cormorant text-5xl sm:text-7xl md:text-8xl text-[#2C241A] font-light leading-none mb-8">
                הרגע שלפני<br /><em className="italic">הרגע הגדול</em>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href={`https://wa.me/${phoneNumber}?text=${encodeURIComponent('היי, אשמח לשמוע פרטים על התארגנות בוילה')}`} target="_blank" rel="noopener noreferrer" className="bg-[#2C241A] hover:bg-[#4a3e2f] text-white px-8 py-3.5 rounded-full text-sm tracking-widest font-medium transition-all shadow-lg">שרייני תאריך</a>
                <button onClick={() => scrollTo('#gallery')} className="text-[#2C241A] border-b border-[#2C241A]/40 pb-0.5 hover:text-[#C9A86A] hover:border-[#C9A86A] transition-all text-sm tracking-widest uppercase font-medium">צפי בגלריה</button>
              </div>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
              {[
                ...
                <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: i * 0.1 }} className="text-center group">
                  <div className="flex justify-center mb-6"><item.icon strokeWidth={1} size={40} className="text-[#C9A86A] group-hover:scale-110 transition-transform duration-500" /></div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
                ...
                <p className="text-[#594937] font-light text-lg leading-relaxed mb-8">
                  המרחב שבו הקסם קורה. סלון רחב ידיים, פינות ישיבה מפנקות, ושפע של אור טבעי שנכנס מהחלונות הגדולים ומשקיף אל הנוף ההררי.<br /><br />
                  כל פרט בוילה תוכנן כדי להעניק לך ולמלוות תחושת רוגע, מרחב ופרטיות מוחלטת.
                </p>
                <button onClick={() => scrollTo('#gallery')} className="inline-flex items-center gap-2 text-[#2C241A] font-medium hover:text-[#C9A86A] transition-colors">
                  <span>לגלריה המלאה</span><ArrowLeft size={16} />
                </button>
              </motion.div>
              <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="relative aspect-[4/5] md:aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl border border-white/50">
                <video controls playsInline preload="metadata" className="absolute inset-0 w-full h-full object-cover">
                  <source src="https://res.cloudinary.com/decirk3zb/video/upload/q_auto,f_auto/v1771445813/111_ezphwg.mp4" type="video/mp4" />
                </video>
              </motion.div>
            </div>
          </div>
        ...
        <section id="gallery" className="py-28 px-6 bg-[#FAF6EE]">
          <div className="max-w-6xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="text-center mb-14">
            ...
            <LuxuryGallery />
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.3 }} className="text-center mt-12">
              <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 border border-[#C9A86A] text-[#A07840] px-8 py-3 rounded-full text-xs tracking-[0.25em] font-medium uppercase hover:bg-[#C9A86A] hover:text-white transition-all duration-300">
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-2xl mx-auto text-center">
            <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="relative w-40 h-40 mx-auto mb-8">
              <div className="absolute inset-0 bg-[#C9A86A] rounded-full opacity-20 blur-xl animate-pulse" />
              <img src="https://res.cloudinary.com/dptyfvwyo/image/upload/v1770475427/%D7%A2%D7%9D_%D7%A7%D7%A4%D7%94_z5rutm.jpg" alt="חגית - המארחת שלך" className="w-full h-full object-cover rounded-full border-[3px] border-white shadow-luxury relative z-10" />
            </motion.div>
            ...
            <p className="text-lg text-[#594937] font-light italic leading-relaxed mb-6">
              "הבית שלי הוא הלב שלי, ואני פותחת אותו בפנייך באהבה גדולה.<br />
        ...
        <section id="pricing" className="py-28 px-6 bg-[#2C241A] text-white">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} whileHover={{ y: -8, transition: { duration: 0.3 } }} className="bg-white/5 border border-[#C9A86A]/30 p-10 rounded-3xl flex flex-col items-center">
                ...
                <ul className="space-y-4 w-full mb-10 flex-grow text-right">
                  {['שימוש בוילה מהבוקר עד אחה״צ','פינת שתייה חמה וקרה חופשית','פירות טריים ופינוקים מתוקים','יין בוטיק מיקב הרי ירושלים','עמדת ביוטי עם תאורה מקצועית','שימוש מלא במתקני הוילה'].map((item, i) => (
                ...
                <a href={`https://wa.me/${phoneNumber}?text=${encodeURIComponent('היי חגית, אשמח לשריין את חבילת הבסיס ב-2,000₪ 💍')}`} target="_blank" rel="noopener noreferrer" className="w-full py-4 rounded-full border border-[#C9A86A] text-[#C9A86A] hover:bg-[#C9A86A] hover:text-white transition-all text-sm tracking-widest font-medium text-center block">אני רוצה את זה</a>
              </motion.div>

              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.15 }} whileHover={{ y: -8, transition: { duration: 0.3 } }} className="bg-[#FAF6EE] text-[#2C241A] p-10 rounded-3xl flex flex-col items-center relative shadow-[0_20px_60px_rgba(0,0,0,0.3)] border-2 border-[#C9A86A]">
                ...
                <ul className="space-y-4 w-full mb-10 flex-grow text-right">
                  {['כל מה שיש בחבילת הבסיס','ארוחת בוקר כפרית עשירה לכולן','שמפניה / קאווה חגיגית לחגיגה','זר פרחים טריים לסלון','מוזיקה אמבינטית ורקע מושלם','שעה נוספת בווילה — כמתנה'].map((item, i) => (
                    <li key={i} className="flex items-start gap-3 text-[#4a3e2f] font-light text-sm">
                      <Check size={15} className="text-[#C9A86A] mt-0.5 shrink-0" /><span>{item}</span>
                    </li>
                  ))}
                </ul>
                <a href={`https://wa.me/${phoneNumber}?text=${encodeURIComponent('היי חגית, אשמח לשריין את חבילת הפרימיום ב-2,500₪ 💍')}`} target="_blank" rel="noopener noreferrer" className="w-full py-4 rounded-full bg-[#2C241A] text-white hover:bg-[#4a3e2f] transition-all text-sm tracking-widest font-medium text-center block shadow-lg">זה בול בשבילי</a>
              </motion.div>
            </div>

            <p className="text-[#7A6550] text-sm font-light mt-12">
              רוצה להוסיף צלמת, מאפרת או שירותים נוספים?{' '}
              <button onClick={() => { const chatBtn = document.querySelector('[aria-label="פתח צ\'אט עם חגית"]') as HTMLButtonElement; if (chatBtn) chatBtn.click() }} className="text-[#C9A86A] hover:text-[#A07840] border-b border-[#C9A86A]/40 transition-colors pb-0.5">בואי נרכיב יחד חבילה מותאמת</button>
            </p>
          </div>
        </section>
        ...
        <section id="contact" className="py-28 px-6 bg-white">
          <div className="max-w-xl mx-auto text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              ...
              <a href={`https://wa.me/${phoneNumber}?text=${encodeURIComponent('היי חגית, אשמח לשמוע פרטים על ההתארגנות בוילה ולשריין תאריך 💍')}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 bg-[#25D366] hover:bg-[#128C7E] text-white px-8 py-4 rounded-full text-sm tracking-widest font-medium transition-all shadow-lg">
