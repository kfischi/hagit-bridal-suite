        ...
        >
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <motion.a
              ...
              className="bg-[#25D366] hover:bg-[#20BA5A] px-7 py-4 rounded-full flex items-center gap-3 pointer-events-auto shadow-warm transition-all hover:shadow-lg"
            >
              ...
              <span className="text-base font-semibold text-white whitespace-nowrap">צור קשר</span>
            </motion.a>
          </div>
        </motion.header>
